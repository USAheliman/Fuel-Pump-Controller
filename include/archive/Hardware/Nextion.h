...
// *********************************************************************************************************************************/
//                  This file contains the functions that are used to communicate with the Nextion display.
// *********************************************************************************************************************************/
...
/*********************************************************************************************************************************/
void SendText(char *tbox, char *NewWord) // This function sends short text to a Nextion display textbox.
{
    char txt[] = ".txt=\"";
    char quote[] = "\"";
    char CB[120];
...
/*********************************************************************************************************************************/
void SendText1(char *tbox, char *NewWord) // This function sends longer text to a Nextion display textbox.
{
    char txt[] = ".txt=\"";
    char quote[] = "\"";
...
/*********************************************************************************************************************************/
void GetTextIn() // This function gets bytes from the Nextion display up to CHARSMAX characters.
{
...
/*********************************************************************************************************************************/
bool GetButtonPress() // This function is called to see if a button was pressed on the Nextion display.
{                      // If a button was pressed, it returns true, otherwise it returns false.
    if (NEXTION.available())
    {
        GetTextIn();
        return true;
...
/*********************************************************************************************************************************/
void SendCommand(char *tbox)  // This function sends a command to the Nextion display.
{
    char page[] = "page ";
...
/*********************************************************************************************************************************/
void EndSend()  // This function sends the end of the input message to the Nextion display.
{
...
/*********************************************************************************************************************************/
void SendValue(char *nbox, int value)   // This function sends a value to a Nextion display box.
{
    char Val[] = ".val=";
    char CB[100];
    char NB[25];
...
uint32_t GetValue(char *nbox) // This function gets the value from a Nextion display box.
